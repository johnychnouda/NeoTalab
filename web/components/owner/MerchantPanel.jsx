...
function BotTab({ m, api, toast, onChanged, onModal }) {
  ...
  const credsOk = !!(m.bot_phone_id && (m.bot_token || m.bot_connected_via === "embedded_signup"));
  ...
  return (
    <>
      ...
      <p style={{ fontSize: 12, color: "var(--text-muted)", marginBottom: 12, lineHeight: 1.5 }}>
        Connect each merchant&apos;s WhatsApp Business number through Meta Embedded Signup. No manual Phone Number ID or token entry.
